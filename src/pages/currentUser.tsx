...
import { placeholderDescription, placeholderEmail, placeholderPhone } from "../debug/currentUserPlaceholders";
...
export default function CurrentUser() {
  ...
  return (
    <div>
      <CurrentUserHeader name={user&& (`${user.first_name} ${user.last_name}`)} avatar={user && user.avatar}/>
      <CurrentUserBody description={placeholderDescription} email={placeholderEmail} phone={placeholderPhone} />
    </div>
  )
}